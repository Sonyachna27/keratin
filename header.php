...
<body <?php body_class(); ?>>
<?php wp_body_open();
include THORGATES_REQUIRE_DIRECTORY . '/template-parts/content-variables.php';?>
<header class="header">
<div class="container">
	<div class="header__container">
		...
		<div class="header__nav">
			...
			<div class="header__socials">
				<div><?= __('СЛІДКУЙТЕ ЗА НАМИ:' , 'headgroup') ?></div>
				<div class="header__socials__wrap"> 
				<?php if($youtube) : ?>
